...
(function() {
    ...
    Lorem.WORDS = [
        "lorem", "ipsum", "valor", "champagne", "amet,", "consectetur", "adipiscing", "elit", "valor", "aliquam,", "agrega", "sit", "amet", "luctus", "quando a pessoa tá na pista ela é mais um.", "lectus", "magna", "fringilla", "urna,", "porttitor", "rhoncus", "dolor", "purus", "agrega seu carro, agrega seu camarote, agrega sua bebida, agrega a tudo!", "a conta você sabe como é, né?", "praesent", "elementum", "facilisis", "Dev de AngularJS tem que ter Instagram, ", "vel", "fringilla", "est", "Agora quando fica no camarote, ", "você pede champanhe, elas vêm ‘toda’ com foooogo", "nulla", "facilisi", "etiam", "dignissim", "acho que é pesado", "quis", "enim", "lobortis", "scelerisque", "cheio de mulheres bonitas", "dui", "o camarote é uma questão de status.", "traz a bebida que pisca", "ornare", "quam", "viverra", "orci", "sagittis", "eu", "volutpat", "odio", "facilisis", "cade o commit que pisca?", "sit", "amet", "massa", "vitae", "tortor", "condimentum", "lacinia", "quis", "sabe uma coisa? ", "eros", "ela pode variar de R$ 5 mil até o infinito.", "ac", "quem tá no camarote tem que ter um Instagram.", "tempor", "orci", "dapibus", "até o infinito", "in", "iaculis", "nunc", "ter um Boing", "augue", "no banheiro!,", "viverra", "vitae", "ter um Instagram", "eu,", "eu já transei com mulher na balada!", "não é legal", "felis", "donec", "et", "odio", "pellentesque", "mas vejo isso como um inveja", "piloto de teco-teco para pilotar", "InDesign agrega", "Dreamweaver não", "egestas", "egestas", "fringilla", "phasellus", "faucibus", "scelerisque", "eleifend", "desenvolvedor transante na balada", "pretium", "vulputate", "sapien", "nec", "sagittis", "aliquam", "malesuada", "bibendum", "arcu", "vitae", "elementum"
    ];
